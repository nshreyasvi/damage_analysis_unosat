...
data_pre = pd.read_csv("pre_disaster_aleppo_small.csv", error_bad_lines=False, names=['long', 'lat', 'elav'])
print (data_pre.head())
print("Pre-Disaster Data Loaded Successfully!")

data_post = pd.read_csv("post_disaster_aleppo_small.csv", error_bad_lines=False, names=['long', 'lat', 'elav'])
...
output_file = open("unfiltered_results_.txt","a")
